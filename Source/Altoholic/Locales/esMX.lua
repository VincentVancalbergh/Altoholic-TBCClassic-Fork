...
L["%s is now ready (%s on %s)"] = "%s ya está listo (%s on %s)"
L["%s is now unlocked (%s on %s)"] = "%s ya está desbloqueado (%s en %s)"
L["%s starts in %d minutes (%s on %s)"] = "%s comienza en %d minutos (%s en %s)"
L["%s will be ready in %d minutes (%s on %s)"] = "%s estará listo en %d minutos (%s en %s)"
L["%s will be unlocked in %d minutes (%s on %s)"] = "%s se desbloqueará en %d minutos (%s en %s)"
...
L["Clamp window to screen"] = "Fijar la ventana a la pantalla"
...
L["COLUMN_ARTIFACT_KNOWLEDGE_SUBTITLE"] = "Bonus por nivel"
L["COLUMN_ARTIFACT_KNOWLEDGE_TITLE"] = "Conocimiento de artefacto"
L["COLUMN_ARTIFACT_KNOWLEDGE_TITLE_SHORT"] = "Conocimiento"
L["COLUMN_ARTIFACT_POWER_SUBTITLE"] = "Costo por nivel"
L["COLUMN_ARTIFACT_POWER_TITLE"] = "Poder de artefacto"
L["COLUMN_ARTIFACT_POWER_TITLE_SHORT"] = "Poder"
L["COLUMN_ARTIFACT_RANK_SUBTITLE"] = "Número total de rangos de los artefactos comprados"
L["COLUMN_ARTIFACT_RANK_TITLE"] = "Rango del artefacto"
L["COLUMN_ARTIFACT_RANK_TITLE_SHORT"] = "Rango"
L["COLUMN_HONOR_SUBTITLE"] = "Tu Honor"
L["COLUMN_HONOR_TITLE"] = "Honor"
L["COLUMN_HONOR_TITLE_SHORT"] = "Honor"
L["COLUMN_ARENAPOINTS_SUBTITLE"] = "Tus Puntos de Arena"
L["COLUMN_ARENAPOINTS_TITLE"] = "Puntos de Arena"
L["COLUMN_ARENAPOINTS_TITLE_SHORT"] = "Puntos de Arena"
