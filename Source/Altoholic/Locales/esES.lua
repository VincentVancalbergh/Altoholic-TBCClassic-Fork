...
L["Clamp window to screen"] = "Fijar ventana a la pantalla"
...
L["TIME_TO_NEXT_WARNING_TEXT"] = "Tiempo hasta el siguiente aviso"
L["TIME_TO_NEXT_WARNING_TOOLTIP"] = "Tiempo hasta el siguiente aviso de caducidad de correo."
...
L["up to"] = "hasta"
L["Up to %s"] = "Hasta %s"
L["Update current tab from"] = "Actualizar pestaña actual desde"
L["Upper Deck"] = true
...
L["Will be %sdeleted|r in"] = "%s se borrará|r en"
L["Will be %sreturned|r in"] = "%s se devolverá|r en"
