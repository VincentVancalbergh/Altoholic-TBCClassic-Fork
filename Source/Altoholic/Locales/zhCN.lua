...
L["Clamp window to screen"] = "窗口始终在屏幕内"
L["Class Books"] = "职业书籍"
L["Class Skills"] = "职业技能"
...
L["Detailed guild bank count"] = "公会银行统计详情"
...
L["Information saved in DataStore has been completely deleted !"] = "数据库中所有存储信息删除完毕！"
L["Inscription"] = "铭文"
...
L["Not recruited at the inn"] = "尚未在旅店招募"
L["Not started"] = "未启动"
...
L["Realm links successfully deleted"] = "服务器链接成功删除"
L["Recruited at the inn"] = "已在旅店招募"
...
L["Reset connected realms"] = "重设已登录服务器"
L["Reset connected realms ?"] = "重设已登录服务器？"
L["Resistance"] = "抗性"
L["Rest XP"] = "奖励经验"
L["Rested"] = "经验奖励"
...
L["Show counters for connected realms"] = "显示登陆过的服务器计数"
...
L["Show pets already known/learnable by"] = "显示由...已知/可学的宠物"
L["Show recipes already known/learnable by"] = "显示由...已知/可学的配方"
...
L["TIME_TO_NEXT_WARNING_TEXT"] = "下次警告的时间"
L["TIME_TO_NEXT_WARNING_TOOLTIP"] = "到下次邮件过期警告最小时间"
L["Timed Chest"] = "限时宝箱"
L["Tin Vein"] = "锡矿"
L["toggle"] = "切换"
...
L["up to"] = "升到"
L["Up to %s"] = "升到%s"
L["Update current tab from"] = "更新目前的标签"
L["Upper Deck"] = "桌面纸牌"
...
L["Visited"] = "已访问"
L["Volcanic Armor"] = "火山"
L["Waiting for %s to accept .."] = "等待 %s 同意 .."
L["Warlock Set"] = "术士套装"
